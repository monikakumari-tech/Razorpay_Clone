...
const Navbar = () => {
  ...
  return (
    <div className={`h-20 overflow-hidden sticky top-0  ${
        scrolled ? "bg-white" : "bg-blue-50"
      } flex `}>
    <div className="m-auto w-[80%]  flex  justify-between text-gray-900 ">
      {/* left */}
      ...
      <img
        ...
        alt="Razorpay Logo"
        className="w-auto h-8 pr-5"
      />
        </div>
        <div className=" gap-4 pl-2 text-[17px] hidden xl:flex ">
          <span>Payments</span>
          <span>Banking+</span>
          <span>Payroll</span>
          <span>Engage</span>
      ...
      onMouseLeave={() => setIsHovered(false)}>
        ...
        <div>
          <Button text={"Sign Up"} className="bg-blue-500 text-white text-sm border border-blue-500"/>
        </div>
      </div>
      {/* visible at less than xl */}
   
     <div className="flex gap-2 items-center xl:hidden">
        <Button text={"Login"} className="text-blue-400 border border-blue-500"/>
